	...
	public class Chooser extends JPanel{
		...
		private void commit() {
	        ...
	        }else if (showDate instanceof JComboBox){
	        	((JComboBox<String>) showDate).addItem(sdf.format(calendar.getTime()));
	        	((JComboBox<?>) showDate).setSelectedItem(sdf.format(calendar.getTime()));;
	        }
	        hidePanel();
	    }
